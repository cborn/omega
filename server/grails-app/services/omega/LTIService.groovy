...
class LTIService {
    ...
    static void createMoodleUser (Site site, Map parameters) {
        ...
        def user = new User(site: site, username: parameters.get("lis_person_contact_email_primary"),moodle_user_id: parameters.get("user_id"), password:pw, fromMoodle:true, firstname: parameters.get("lis_person_name_given"), surname: parameters.get("lis_person_name_family"), enabled: 'true', salt: salt).save(failOnError:true)
    ...
    static String generateMoodlePassword(String email, String name, String salt) {
    ...
    static PASSBACK_ROLES[] decideUserRole(String roleListStr) {
 ...
 */
    ...
    static String generateOAuthSignature(String method, String url, String consumerSecret, Map parameters) {
